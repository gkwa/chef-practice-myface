...
** install/setup chefdk environment summary




curl -sS -LO https://releases.hashicorp.com/vagrant/1.8.4/vagrant_1.8.4_x86_64.deb
dpkg -i vagrant_1.8.4_x86_64.deb
curl https://omnitruck.chef.io/install.sh | bash -s -- -v 0.14.25 -P chefdk
